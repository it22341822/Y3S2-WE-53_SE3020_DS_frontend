...
;
;
const ReviewForm = ({ restaurantId, onSave })=>{
    ...
    const validateForm = ()=>{
        ...
        if (!reviewText.trim()) {
            ...
            newErrors.reviewText = 'Review must be 100 characters or less';
            valid = false;
        }
...
const Home = ()=>{
    ...
    const fetchReviews = async ()=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get(`/api/reviews/${restaurantId}`);
    ...
    const handleEdit = async (reviewId, updatedReview)=>{
        try {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].put(`/api/reviews/${reviewId}`, updatedReview);
            fetchReviews();
            return true;
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ed33e316._.js.map